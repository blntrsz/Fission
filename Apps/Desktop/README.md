# Desktop (Swift, reference)

The current Fission desktop app is Electron: `packages/electron`. `mise run desktop` launches that package.

This directory still contains the previous SwiftUI/Ghostty macOS application.
